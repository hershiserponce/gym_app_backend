...
export interface ApiClientMembershipClientMembership
  extends Struct.CollectionTypeSchema {
...
export interface ApiInventoryMovementInventoryMovement
  ...
  attributes: {
    ...
    referenceType: Schema.Attribute.Enumeration<
      ['purchase', 'sale', 'adjustment', 'expiration']
    >;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    client: Schema.Attribute.Relation<'manyToOne', 'api::client.client'> &
      Schema.Attribute.Required;
    clientMembership: Schema.Attribute.Relation<
      'manyToOne',
      'api::client-membership.client-membership'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSaleSale extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    receiptNumber: Schema.Attribute.String & Schema.Attribute.Unique;
    saleDate: Schema.Attribute.DateTime;
